...
width="80%"> <source
src="https://surfdrive.surf.nl/files/index.php/s/NnOmq0h7cEj9XE4/download"
...
<div class="figure"> <video controls="" preload="metadata"
width="80%"> <source
src="https://surfdrive.surf.nl/files/index.php/s/sbIEsUUxxqFRbeT/download"
type="video/mp4"> Your browser does not support the video
tag. </video> <p class="caption"> The $\lambda_2$ vortex-detection
isosurfaces reveal the dynamics in great detail. (Video via surfdrive)
</p> </div>
